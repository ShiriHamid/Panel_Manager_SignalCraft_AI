  ...
  return (
    <div style={{display:"flex",flexDirection:isMobile?"column":"row",height:"100vh",background:"#0b0b14",color:"#e2e8f0",fontFamily:"system-ui,sans-serif",overflow:"hidden"}}>
      ...
      <div style={{flex:1,display:"flex",flexDirection:"column",overflow:"hidden",paddingBottom:isMobile?70:0}}>
        ...
        {/* Date tabs */}
        <div style={{background:"#0f0f1c",borderBottom:"1px solid #1a1a30",padding:isMobile?"10px 16px":"0 22px",display:"flex",gap:8,flexShrink:0,overflowX:"auto"}}>
        ...
        {/* Scrollable content */}
        <div style={{flex:1,overflow:"auto",padding:isMobile?"12px":"20px",display:"flex",flexDirection:"column",gap:isMobile?10:16}}>
