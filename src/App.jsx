...
// ✅ FIX: Use Europe/London timezone instead of UTC
const toDateStr = (n) => {
  const d = new Date();
...
// ✅ FIX: Compute dates fresh (not as module-level constants)
const getDates = () => {
...
export default function App() {
  ...
  useEffect(() => {
    ...
    const clock = setInterval(() => {
      setNow(new Date());
      // ✅ FIX: Refresh dates every minute in case day rolled over
      setDates(getDates());
    }, 30000);
