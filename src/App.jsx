  ...
  const fetchBlocked = async () => {
    try {
      ...
      const mapped = records.map(r => ({
        ...
        date: r.fields?.Date ? r.fields.Date.split("T")[0] : (r.Date || ""),
              ...
              <div style={{padding:"16px 18px",overflow:"auto"}}>
                ...
                <div style={{position:"relative"}}>
                  ...
                  {TABLES.map(t=>{
                    ...
                    const isBlocked = blockedForDate.some(b => b.table_id === t.id && (b.session === "All" || b.session === (session === "lunch" ? "Lunch" : "Dinner")));
                    return (
                          ...
                          {isBlocked ? (
                            <div style={{position:"absolute",inset:0,display:"flex",alignItems:"center",paddingLeft:8}}>
                              <span style={{fontSize:10,color:"#ef4444",fontWeight:600}}>
                                Blocked — {blockedForDate.find(b=>b.table_id===t.id)?.reason || ""}
                              </span>
                            </div>
                          ) : (
                            <>
